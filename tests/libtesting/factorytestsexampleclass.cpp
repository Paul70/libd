...
ConstructionValidator const& Base::getConstructionValidator()
{
  static const ConstructionValidator cv(
      {[] {
        auto sr
            = SettingRule::forNamedParameter<BaseFlag>(SettingRule::Usage::OPTIONAL, "Base flag");
...
{
  static const ConstructionValidator cv(
      {SettingRule::forNamedParameter<DerivedAInt>(SettingRule::Usage::MANDATORY_NO_DEFAULT,
                                                   "DerivedAInt"),
...
{
  static const ConstructionValidator cv(
      {SettingRule::forNamedParameter<DerivedBInt>(SettingRule::Usage::MANDATORY_NO_DEFAULT,
                                                   "DerivedBInt"),
...
{
  static const ConstructionValidator cv({SettingRule::forNamedParameter<TemporaryReal>(
                                            SettingRule::Usage::OPTIONAL, "Temporary real")},
                                        {}, Base::getConstructionValidator());
  return cv;
}
