...
struct ConstructionData
{
  ...
  std::string createSharedWareKeyWithCounter(std::string key,
                                             std::shared_ptr<const Ware> sharedWarePtr) const;
  ...
  {
    subObjectData.emplace(
        std::make_pair(createSubObjectKeyWithCounter(NR::getReferenceName()), cd));
    return *this;
  }
